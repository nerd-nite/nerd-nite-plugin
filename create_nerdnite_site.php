    ...
    <fieldset>
        ...
        <dl>
            ...
            <dd>With this type, emails go into your very own Nerd Nite mailbox.
                ...
                you can send emails from this address.
            </dd>
        ...
        <table class="appendo">
            <tr>
                ...
                <td><label for="desired_email[]">NN Email</label> <input type="text"
                                                                         name="desired_email[]"/>@nerdnite.com
                </td>
...
<pre>
    ...
    for ($i = 0; $i < sizeof($_POST['name']); ++$i) {
        $boss = array(name => $_POST['name'][$i], current_email => $_POST['current_email'][$i],
                      desired_email => $_POST['desired_email'][$i], email_type => $_POST['email_type'][$i],);
